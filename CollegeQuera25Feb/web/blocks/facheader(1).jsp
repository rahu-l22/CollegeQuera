...
<head>
    ...
    <title>Universal College : Faculty</title>
<!--
Neaty HTML Template
                ...
                <div class="tm-left-right-container">
                    ...
                    <div class="tm-blue-bg tm-left-column">                        
                        <div class="tm-logo-div text-xs-center">
                            ...
                            <h1 class="tm-site-name">Hello Sir/Madam !</h1>
                        </div>
                        <nav class="tm-main-nav">
                            <ul class="tm-main-nav-ul">
                                <li class="tm-nav-item">
                                    <a href="<%=ctx%>/faculty/fachome.jsp" class="tm-nav-item-link">Home</a>
                                </li> 
                                
                                <li class="tm-nav-item">
                                    <a href="<%=ctx%>/faculty/facprofile.jsp" class="tm-nav-item-link">Profile</a>
                                </li> 
